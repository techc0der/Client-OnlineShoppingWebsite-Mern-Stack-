...
const Showproduct = ({ cartproduct, setcartproduct }) => {
  ...
  const filterSubmit = (e) => {
    ...
    fetch(`https://backend-onlineshoppingwebsite-mern-stack.onrender.com/product/filter?${params.toString()}`, {
      method: 'POST',
      headers: {
  ...
  const addcart = (e, product1) => {
    ...
    fetch('https://backend-onlineshoppingwebsite-mern-stack.onrender.com/product/addcart', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
