...
function AppContent({ cartproduct, setcartproduct }) {
  ...
  const searchproduct = async () => {
    await fetch('https://backend-onlineshoppingwebsite-mern-stack.onrender.com/product')  // Replace with your API endpoint
  ...
  const profile = async() => {
    ...
    await fetch('https://backend-onlineshoppingwebsite-mern-stack.onrender.com/user/',{
      method: "POST",
      headers: {
